...
/******* Added by Pedro Rojas *********/
#pragma mark - Code Added by Pedro Rojas
...
{
    return (tableView == self.searchDisplayController.searchResultsTableView) ? [self.searchResults count] : [self.recipes count];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    Recipe *recipe = (tableView == self.searchDisplayController.searchResultsTableView) ? self.searchResults[indexPath.row] : self.recipes[indexPath.row];
